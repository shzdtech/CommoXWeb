...
export const UPDATE_REQUIREMENT_SORTER = 'UPDATE_REQUIREMENT_SORTER';
...
export const GET_ENTERPRISE_USER_SUCCESS = 'GET_ENTERPRISE_USER_SUCCESS';
export const DELETE_ENTERPRISE_USER_SUCCESS = 'DELETE_ENTERPRISE_USER_SUCCESS';
